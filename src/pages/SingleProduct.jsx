                        ...
                        <div className="main-product-details">
                            ...
                            <div className="py-3">
                                ...
                                <div className="d-flex align-items-center gap-15">
                                    <div className="">
                                        <a href="">
                                            <TbGitCompare className="fs-4 me-1" />{" "}
                                            Add to Compare
                                        </a>
                                    </div>
                                    <div className="">
                                        <a href="">
                                            <AiOutlineHeart className="fs-4 me-1" />{" "}
                                            Add to Wishlist
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="col-12">
                            ...
                            <div className="bg-white p-3">
                                <p>
                                    ...
                                    adipisicing elit. Nulla, velit consequatur?
                                    Laboriosam consequuntur qui sed ipsam soluta
                                    culpa necessitatibus possimus nam pariatur,
                                    quasi, perspiciatis deserunt voluptatibus
                                    neque impedit. Quod, ab!
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="reviews">
                                    <div className="review mb-3">
                                        ...
                                        <p className="mt-3">
                                            ...
                                            suscipit quasi quos quae inventore
                                            commodi consectetur fuga ea impedit,
                                            reprehenderit et. Assumenda fuga
                                            eius deleniti aliquam.
                                        </p>
                                    </div>
